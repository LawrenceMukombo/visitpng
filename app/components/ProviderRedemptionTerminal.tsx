    ...
    <div className="sheetOverlay" role="dialog" aria-modal="true">
      <div className="sheetCard terminalSheetCard">
        <header className="terminalSheetHeader">
          <div>
            <p className="eyebrow lime">{isZambia ? "VISIT ZAMBIA PARTNER REDEMPTION TERMINAL" : "VISIT PNG PARTNER REDEMPTION TERMINAL"}</p>
          ...
          <form className="terminalInputForm" onSubmit={handleVerify}>
            <label>
              ...
              <div className="terminalInputRow">
                <input
                  required
                  placeholder={isZambia ? "e.g. VZAMQR-VZAM-000001-... or VZAM-000001" : "e.g. VPNGQR-VPNG-000001-... or VPNG-000001"}
                  value={tokenInput}
