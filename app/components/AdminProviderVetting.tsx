            ...
            <div className="inspectorSection checklistSection">
              ...
              <div className="checklistGrid">
                <label className="checkItem">
                  ...
                  />
                  <span>1. National ID / Passport Authenticated</span>
                </label>
                ...
                <label className="checkItem">
                  ...
                  />
                  <span>2. TPA License / Local Association Verified</span>
                </label>
                ...
                <label className="checkItem">
                  ...
                  />
                  <span>3. Customary Land / Clan Leader Endorsed</span>
                </label>
                ...
                <label className="checkItem">
                  ...
                  />
                  <span>5. Transport / Equipment / Lodge Inspected</span>
                </label>
              </div>
            </div>
