...
export default function AdminOperationsConsole({ initialTab = "bookings", currency = "PGK" }: AdminOperationsConsoleProps) {
  ...
  return (
    <div className="adminOperationsSection">
      {/* KPI Cards */}
      <div className="operationsKpiGrid">
        <div className="opKpiCard">
          <small>CONFIRMED REVENUE</small>
          <strong>{formatPrice(totalRevenue, currency)}</strong>
          <span>Across all PNG listings</span>
        </div>
        <div className="opKpiCard">
          <small>ACTIVE BOOKINGS</small>
          <strong>{activeBookingsCount}</strong>
          <span>Held & confirmed stays</span>
        </div>
        <div className="opKpiCard">
        ...
        <div className="opKpiCard">
          ...
          <span>Provider / tourist resolutions</span>
        </div>
      </div>
