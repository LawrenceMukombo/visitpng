export type CurrencyCode = "PGK" | "AUD" | "USD" | "EUR" | "GBP" | "JPY" | "ZMW";

export interface CurrencyInfo {
  code: CurrencyCode;
  symbol: string;
  name: string;
  rateAgainstPgk: number; // e.g. 1 PGK = 0.40 AUD, 1 PGK = 6.8 ZMW
  flag: string;
}

export const CURRENCIES: Record<CurrencyCode, CurrencyInfo> = {
  PGK: { code: "PGK", symbol: "K", name: "Papua New Guinea Kina", rateAgainstPgk: 1.0, flag: "🇵🇬" },
  ZMW: { code: "ZMW", symbol: "ZK", name: "Zambian Kwacha", rateAgainstPgk: 6.8, flag: "🇿🇲" },
