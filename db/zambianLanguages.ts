...
export const ZAMBIAN_LANGUAGE_ZONES: ZambianLanguageZone[] = [
  ...
  },
  {
    ...
    phrases: [
      { id: "lu-1", category: "greetings", english: "Welcome / Come in", localText: "Shikenu mwani / Menekenu mwani", phonetic: "shee-keh-noo mwah-nee / meh-neh-keh-noo mwah-nee", syllables: "Shi-ke-nu mwa-ni / Me-ne-ke-nu mwa-ni", culturalNote: "Standard polite welcome to guests and travelers in Chilunda." },
      { id: "lu-2", category: "greetings", english: "I am greeting you", localText: "Tunemushi mwani", phonetic: "too-neh-moo-shee mwah-nee", syllables: "Tu-ne-mu-shi mwa-ni", culturalNote: "Respectful opening greeting." },
      { id: "lu-3", category: "greetings", english: "Good morning (in passing)", localText: "Ntetamena mwani", phonetic: "n-teh-tah-meh-nah mwah-nee", syllables: "Nte-ta-me-na mwa-ni", culturalNote: "Traditional early morning greeting before midday." },
      { id: "lu-4", category: "greetings", english: "Good evening", localText: "Melela mwani", phonetic: "meh-leh-lah mwah-nee", syllables: "Me-le-la mwa-ni", culturalNote: "Used during evening gatherings." },
      { id: "lu-5", category: "greetings", english: "Are you well?", localText: "Mwakola mwani?", phonetic: "mwah-koh-lah mwah-nee", syllables: "Mwa-ko-la mwa-ni", literalMeaning: "Are you strong/well?" },
      { id: "lu-6", category: "greetings", english: "I am well", localText: "Nidi chachiwahi", phonetic: "nee-dee chah-chee-wah-hee", syllables: "Ni-di cha-chi-wa-hi", culturalNote: "Standard answer indicating sound health and peace." },
      { id: "lu-7", category: "greetings", english: "And you?", localText: "Ndeyi mwani?", phonetic: "n-deh-yee mwah-nee", syllables: "Nde-yi mwa-ni" },
      { id: "lu-8", category: "greetings", english: "Not so well", localText: "Chanti chanti", phonetic: "chahn-tee chahn-tee", syllables: "Chan-ti chan-ti", literalMeaning: "Just a bit / so-so." },
      { id: "lu-9", category: "greetings", english: "Thank you", localText: "Nasakalili mwani / Twasakilila mwani", phonetic: "nah-sah-kah-lee-lee mwah-nee", syllables: "Na-sa-ka-li-li mwa-ni", culturalNote: "Essential expression of gratitude in Lunda culture." },
      { id: "lu-10", category: "greetings", english: "You're welcome / That is good", localText: "Chachiwahi mwani", phonetic: "chah-chee-wah-hee mwah-nee", syllables: "Cha-chi-wa-hi mwa-ni" },
      { id: "lu-11", category: "greetings", english: "I am sorry / Excuse me", localText: "Nanakeni mwani", phonetic: "nyah-nah-keh-nee mwah-nee", syllables: "Nya-na-ke-ni mwa-ni" },
      { id: "lu-12", category: "greetings", english: "Yes / No", localText: "Eña / Nehi", phonetic: "eh-nyah / neh-hee", syllables: "E-nya / Ne-hi" },
      { id: "lu-13", category: "greetings", english: "What is your name?", localText: "Ijina deyi yeyinyi?", phonetic: "ee-jee-nah deh-yee yeh-yeen-yee", syllables: "I-ji-na de-yi ye-yin-yi" },
      { id: "lu-14", category: "greetings", english: "My name is...", localText: "Ami yami...", phonetic: "ah-mee yah-mee...", syllables: "A-mi ya-mi..." },
      { id: "lu-15", category: "navigation", english: "Where are you from?", localText: "Wunafumi kudihi?", phonetic: "woo-nah-foo-mee koo-dee-hee", syllables: "Wu-na-fu-mi ku-di-hi" },
      { id: "lu-16", category: "navigation", english: "Where? / Far away", localText: "Kudihi? / Kwakulehi", phonetic: "koo-dee-hee? / kwah-koo-leh-hee", syllables: "Ku-di-hi? / Kwa-ku-le-hi" },
      { id: "lu-17", category: "culture", english: "Greeting to people working", localText: "Mukalakalanga mwani", phonetic: "moo-kah-lah-kah-lahn-gah mwah-nee", syllables: "Mu-ka-la-ka-lan-ga mwa-ni", culturalNote: "Respectful encouragement spoken to workers, builders or farmers." },
      { id: "lu-18", category: "culture", english: "I am trying to learn to speak Lunda!", localText: "Ami nakufwila kudiza kuhosha Lunda!", phonetic: "ah-mee nah-koo-fwee-lah koo-dee-zah koo-hoh-shah loon-dah", syllables: "A-mi na-ku-fwi-la ku-di-za ku-ho-sha Lun-da" },
      { id: "lu-19", category: "navigation", english: "Speak slowly please", localText: "Hoshaku chovu mwani", phonetic: "hoh-shah-koo choh-voo mwah-nee", syllables: "Ho-sha-ku cho-vu mwa-ni" },
      { id: "lu-20", category: "navigation", english: "Please say it again", localText: "Hoshenu cheñi mwani", phonetic: "hoh-sheh-noo chehn-yee mwah-nee", syllables: "Ho-she-nu che-nyi mwa-ni" },
      { id: "lu-21", category: "emergency", english: "Help me with... / Can I help you?", localText: "Ankwashuku na... / Nikukwashi tahindi?", phonetic: "ahn-kwah-shoo-koo nah... / nee-koo-kwah-shee tah-heen-dee?", syllables: "An-kwa-shu-ku na... / Ni-ku-kwa-shi ta-hin-di?" },
      { id: "lu-22", category: "emergency", english: "I do not understand / Do you understand?", localText: "Hinachitiyuku / Wunachitiyi?", phonetic: "hee-nah-chee-tee-yoo-koo / woo-nah-chee-tee-yee?", syllables: "Hi-na-chi-ti-yu-ku / Wu-na-chi-ti-yi?" },
      { id: "lu-23", category: "safari", english: "Source of the Zambezi River", localText: "Nsulu ya Kalwiji Yezambezi", phonetic: "n-soo-loo yah kah-lwee-jee yeh-zahm-beh-zee", syllables: "Nsu-lu ya Ka-lwi-ji Ye-zam-be-zi", literalMeaning: "Sacred springhead of the great Zambezi River in Ikelenge." }
    ]
  },
  {
    code: "luvale",
